...
<h1 class="text-5xl justify-center text-white">Liste des Filières</h1>
@if($filieres->count())
<div class="p-4">
        <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <li class="border border-gray-300 p-2 my-2">
                    ...
                    <h1 class="text-white text-xl font-bold">{{$filiere->name}}</h1>
                    <p class="text-white">{{$filiere->code}}</p>
