        ...
        @endif
         ...
         <div class="steps-wrapper mb-6">
            <div class="step" id="step1">
                ...
                <div class="mb-4">
                    <label for="nom" class="block text-sm font-medium text-white dark:text-gray-300">Nom</label>
                ...
                <div class="mb-4">
                     <label for="prenom" class="block text-sm font-medium text-white dark:text-gray-300">Prénom</label>
                ...
                <div class="mb-4 flex w-full lg:flex-row gap-4">
                    <div>
                        <label for="date_naissance" class="block text-sm font-medium text-white">Date de Naissance</label>
                    ...
                    <div>
                        <label for="ville" class="block text-sm font-medium text-white">Lieu de Naissance</label>
                ...
                <div class="flex w-full lg:flex-row gap-4">
                    <label for="sexe" class="block text-sm font-medium text-white">Sexe :</label>
                    <div>
                        <input type="radio" id="masculin" name="sexe" value="M" class="mr-2" required>
                        <label for="homme" class="mr-4 text-white">Masculin</label>
                    </div>
                    <div>
                        <input type="radio" id="feminin" name="sexe" value="F" class="mr-2 ">
                        <label for="femme" class="text-white">Feminin</label>
                    </div>
                </div>
            </div>
            <div class="mb-4">
                <label for="nationalite" class="block text-sm font-medium text-white">Nationalite</label>
            ...
            <div class="mb-4">
                <div class="flex w-full lg:flex-row gap-4" required>
                    <label for="situation" class="block text-sm font-medium text-white">Situation Familiale :</label>
                    <div>
                        <input type="radio" id="marie" name="situation_familiale" value="marié" class="mr-2">
                        <label for="marie" class="mr-4 text-white">Marie</label>
                    </div>
                    <div>
                        <input type="radio" id="celibataire" name="situation_familiale" value="celibataire" class="mr-2">
                        <label for="femme" class="text-white">Celibataire</label>
                    </div>
                </div>
            </div>
            <div class="mb-4">
                <div class="flex w-full lg:flex-row gap-4" required>
                    <label for="sexe" class="block text-sm font-medium text-white">Ete-vous en Situation Handicape ? :</label>
                <div>
                        <input type="radio" id="oui" name="handicape" value="1" class="mr-2" >
                        <label for="oui" class="mr-4 text-white">Oui</label>
                </div>
                    <div>
                        <input type="radio" id="non" name="handicape" value="0" class="mr-2">
                        <label for="femme" class="text-white">Non</label>
                    </div>
                </div>
            </div>
